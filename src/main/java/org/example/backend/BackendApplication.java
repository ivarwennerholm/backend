...
public class BackendApplication {
    ...
    public CommandLineRunner commandLineRunner(CustomerRepository cRepo, RoomTypeRepository rtRepo, RoomRepository rRepo, BookingRepository bRepo) {
        return (args) -> {
            ...
            // Room Types
            RoomType rt1 = new RoomType(1L, "single", 0, 1);
            RoomType rt2 = new RoomType(2L, "double", 1, 3);
            RoomType rt3 = new RoomType(3L, "large_double", 2, 4);
            rtRepo.save(rt1);
            rtRepo.save(rt2);
            rtRepo.save(rt3);

            // Rooms
            Room r1 = new Room(101, 2099, rt1);
            Room r2 = new Room(102, 3049, rt2);
            Room r3 = new Room(103, 3540, rt3);
            rRepo.save(r1);
            rRepo.save(r2);
            rRepo.save(r3);
