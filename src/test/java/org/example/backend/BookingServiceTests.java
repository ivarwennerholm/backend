...
public class BookingServiceTests {
    ...
    */
    ...
    public void deleteBookingByIdTest() {
        Assertions.assertTrue(sut.deleteBookingById(1L).equals("delete booking id 1"));
    }

    @Test
    public void updateBookingDatesTest() throws ParseException {
        when(bookRepo.findAll()).thenReturn(Arrays.asList(b1, b2));
        Assertions.assertTrue(sut.updateBookingDates(1L, "2024-06-08", "2024-06-31").equals("booking is updated"));
        Exception ex = assertThrows(RuntimeException.class, () -> sut.updateBookingDates(1L, "2024-07-01", "2024-07-31"));
